...
//  GFS Tests
//
//  Created by Michal Cisarik on 7/6/14.
...
@interface GFS_Tests : XCTestCase
@end

@implementation GFS_Tests
...
-(void)testGFStoString {
    
    int i=0;
    
    GFS *gfs=[[GFS alloc]initWithFunctionSet:(uint64)UINT64_MAX];
    //[gfs setValueOf:@"x" value:(double)1];
    ...
    XCTAssertEqualObjects(out, @"(sin(tan(7))+cos(2))", @"Hmm");
